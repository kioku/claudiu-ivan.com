...
<Annotation>
**[Try it in StackBlitz →](/playground/result-option-types/)** The companion code implements everything discussed in this article from scratch. You can step through the type definitions, run the examples, and modify them to see how the compiler responds to missing error handling.
</Annotation>
