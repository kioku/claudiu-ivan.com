...
<Annotation>
  ...
  but relying on developers to consistently check creates fragility. The type
  system can help, but traditional patterns place the burden of correctness on
  vigilance rather than structure.
</Annotation>
